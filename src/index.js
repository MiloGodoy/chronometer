...
function executeTimer(){
    hero.innerHTML = `
        ...
        <div class="hero--buttons">
            ...
            <input type="number" placeholder="Enter minutes" id="minutesInput" name="minutes">
            <input type="number" placeholder="Enter seconds" id="secondsInput" name="seconds">
...
function startPomodoro(){
    ...
    currentInterval = setInterval(() => {
        ...
        if(minutesValue === 0 && secondsValue === 0){
            ...
            title.textContent = "POMODORO IS FINISHED";
